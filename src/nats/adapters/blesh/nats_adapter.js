...
import BleshAdapter from "@patonz/uhura_device_adapter_blesh";
...
let bleshAdapter = new BleshAdapter('/dev/ttyACM0', 'Laptop');
bleshAdapter.eventEmitter.on('message_received', (data)=>{
    console.log(data);
})
let count = 0;
setInterval(() => {
